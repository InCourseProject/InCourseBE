...
public class PlaceService {
    ...
    //카드 생성
    @Transactional
    public void placeCreate(Long postId, PlaceRequestDto placeRequestDto, Member member)
//            throws IOException
    {
...
//        String placeImage = s3Uploader.upload(image, "static");
        ...
        Place place = new Place(postId, placeRequestDto, member);
    ...
    //카드 수정
    @Transactional
    public void placeUpdate(PlacePutDto placePutDto, Member member) {
