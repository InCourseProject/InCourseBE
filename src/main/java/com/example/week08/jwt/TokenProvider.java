...
import com.example.week08.auth.Authority;
...
import static com.example.week08.errorhandler.ErrorCode.JWT_NOT_PERMIT;
...
public class TokenProvider {
    ...
    public Member getMemberFromAuthentication() {
        ...
        if (authentication == null || AnonymousAuthenticationToken.class.
            ...
            throw new BusinessException("Member 가 존재하지 않습니다.", ErrorCode.MEMBER_NOT_EXIST);
        }
